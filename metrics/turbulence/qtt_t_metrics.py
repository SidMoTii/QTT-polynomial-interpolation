...
for run_idx in range(initial,initial+num_runs):
    ...
    seps, flats = compute_flatness_p(u, max_sep, L)
...
df_flatness.to_csv('./data/flatness_qtt8_e8_p.csv', index=False)
df_energy.to_csv('./data/energy_qtt8_e8.csv', index=False)